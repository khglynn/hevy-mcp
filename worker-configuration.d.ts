...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MCP_INVITE_CODE" | "OWNER_TOKEN" | "OPERATOR_NAME" | "TIP_URL">> {}
}
